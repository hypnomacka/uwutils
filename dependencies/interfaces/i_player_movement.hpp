...
class player_prediction {
	...
	struct Split_t {
		...
		int vecEntitiesWithPredictionErrorsInLastAck; 
	...
	bool in_prediction() {
		...
		return util::call_virtual<o_in_prediction>(this, 14)(this);
	}
	...
	void run_command(player_t* player, c_usercmd* cmd, player_move_helper* helper) {
		...
		return util::call_virtual<o_run_command>(this, 19)(this, player, cmd, helper);
	}
	...
	void setup_move(player_t* player, c_usercmd* cmd, player_move_helper* helper, void* data) {
		...
		return util::call_virtual<o_setup_move>(this, 20)(this, player, cmd, helper, data);
	}
	...
	void finish_move(player_t* player, c_usercmd* cmd, void* data) {
		...
		return util::call_virtual<o_finish_move>(this, 21)(this, player, cmd, data);
	}
};
